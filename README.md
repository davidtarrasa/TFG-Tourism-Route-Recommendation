...
- `data/reports/figures/tfg/`: thesis figures (fig_01–fig_19 + mermaid diagrams, generated by `scripts/generate_tfg_figures.py`)
...
## Benchmark Results (hit@10, last_trail_user protocol)

Latest results across 3 cities:
